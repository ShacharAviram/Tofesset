            ...
            if Game_begin:
                ...
                if loop_num == 1:
                    ...
                    for client_socket in clients:
                        ...
                        if clients[client_socket]['data'].decode('utf-8') == toffes:
                            ...
                            # We are reusing here message header sent by sender, and saved username header send
                            # by user when he connected
                ...
                for client_socket in clients:
                    ...
                    if clients[client_socket] == message and \
                        ...
                        # Send user and message (both with their headers)
                        # We are reusing here message header sent by sender, and saved username header send by user
                        # when he connected
